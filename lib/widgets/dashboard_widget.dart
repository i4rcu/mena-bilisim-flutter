...
import 'package:fitness_dashboard_ui/widgets/satis_faturalari_card.dart';
  ...
  providers: [
    ...
    BlocProvider(
        create: (context) => AlinanFaturalarBloc(ApiHandler())
          ..add(LoadAlinanAndSatisFaturalar(prefix: "", suffix: ""))),
    BlocProvider(
        create: (context) =>
                            ...
                            children: [
                              Row(
                                children: [
                                  ...
                                  Expanded(
                                    flex: 1,
                                    child:
                                        CariHeasplarKart(isDesktop: isDesktop),
                                  ),
                                ],
                              ),
                              const SizedBox(height: 0),
                              ...
                              Row(
                                children: [
                                  Expanded(
                                    flex: 1,
                                    child: AlisFaturalari(isDesktop: isDesktop),
                                  ),
                                  const SizedBox(width: 1),
                                  Expanded(
                                    flex: 1,
                                    child:
                                        SatisFaturalari(isDesktop: isDesktop),
                                  ),
                                ],
                              ),
                            ],
