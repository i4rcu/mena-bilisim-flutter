    ...
    return BlocListener<AdminBloc, AdminState>(
      listener: (context, state) {
        if (state is RaporUpdated) {
          ...
          ScaffoldMessenger.of(context).showSnackBar(
            const SnackBar(content: Text('Rapor Bilgileri Başarıyla Güncellendi.')),
          );
      ...
      child: Scaffold(
        appBar: AppBar(
          ...
          title: const Text('Rapor Güncelle', style: TextStyle(color: Colors.white)),
              ...
              child: Column(
                children: <Widget>[
                  ...
                  ElevatedButton(
                    ...
                    onPressed: () {
                      if (_validateInputs()) {
                        // Trigger the UpdateRapor event with updated values
