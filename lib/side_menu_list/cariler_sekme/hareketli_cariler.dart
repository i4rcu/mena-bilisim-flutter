...
class ClientTotalsPage extends StatefulWidget {
  @override
  _ClientTotalsPageState createState() => _ClientTotalsPageState();
}

class _ClientTotalsPageState extends State<ClientTotalsPage> {
  DateTime? _startDate =
  ...
  String _searchText = "";
  List<HareketliCariler> _fetchedData = [];
  ...
  void _fetchData() {
    if (_startDate != null && _endDate != null) {
      ...
      context.read<CariHesapBloc>().add(FetchHareketliCariHesaplar(
            formattedStartDate,
            formattedEndDate,
          ));
    }
            ...
            Expanded(
              child: BlocConsumer<CariHesapBloc, CariHesapState>(
                listener: (context, state) {
                  if (state is HareketliCariHesapError) {
                ...
                builder: (context, state) {
                  if (state is HareketliCariHesapLoading) {
                    return Center(child: CircularProgressIndicator());
                  } else if (state is HareketliCariHesapLoaded) {
                    _fetchedData = state.hareketli_cariler;
                  ...
                  } else if (state is HareketliCariHesapError) {
